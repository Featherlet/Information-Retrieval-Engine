...
public class InvertedIndex {
    ...
    public static class MyInvertedIndexMapper extends Mapper<Object, Text, Text, Text> {
    ...
    public static class MyInvertedIndexReducer extends Reducer<Text, Text, Text, Text> {
        @Override
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            for (Text value : values) {
                ...
                int times = map.getOrDefault(map.get(docID), 0);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(MyInvertedIndexMapper.class);
        job.setReducerClass(MyInvertedIndexReducer.class);
